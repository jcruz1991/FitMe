...
public class Choose_Workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                //Saved the workout that user want in the selected date
                Workout ex = new Workout(text,"null", usermail,"null", "null", savedDate);
                myRef.push().setValue(ex);
                Intent intent = new Intent(Choose_Workout.this, Calendar.class);
